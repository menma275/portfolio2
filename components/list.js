const WorkList = [
  ...
  },
  {
    ...
    tags: ["Arduino"],
    url: "",
    outlineJA:"enLightnmentは「何もしない」を主眼に置いたインタラクティブアートです。瞑想を促す装置として機能し、集中に応じてオブジェクトの持つ光が強くなっていき、集中力を高めるために必要な「何もしない」を視覚的にもわかりやすく体験することができます。\nこの作品は東京都立大学の授業「インタラクティブアート演習・実習I」の課題として制作されました。",
    outlineEN:"enLightnment is an interactive art that focuses on \"Do Nothing\". It functions as a device to promote meditation, and the light of the object becomes stronger depending on the concentration, so that you can visually and easily experience the \"Do Nothing\" necessary to increase your concentration.\n This work was created as a class assignment for the course \"Interactive Art Exercise and Practice I\" at Tokyo Metropolitan University.",
    thoughtJA:"本作品を制作する際に、現代の生活を送る私たちが「何もしない」ことの難しさを感じました。私たちは常に何かをしているという状態にあり、何もしないことが難しいのです。また、現代は常に何かに注意を惹きつけられるような環境にあり、自分と向き合う時間が少なくなっていると感じました。そこで、私たちが「何もしない」ことを視覚的に体験できるような作品を通して、自分と向き合う時間を作ることができればと考えました。",
    thoughtEN:"This work was created as a miniature of light as visual information and sound as auditory information, aiming to make a small world appear in front of you by standing in front of this work. \n Although it is an interactive art of sound and light, it does not encourage the viewer to take active action. The viewer can participate in the work just by walking in front of it, and there is no need to make a special gesture. It is similar to the fact that we experience them by simply existing without taking any special action against the light and sound that exist in the world.",
  },
  {
    junle: "Web_Content",
  ...
  },
  {
    ...
    outlineJA:"本Webサイトは東京都立大学の大学祭で開催されたインタラクティブアートの展示「有機的、無機的」の広報のために制作されました。バックグラウンドにはThree.jsとWebGLを用いて、有機的な形状と無機的な形状が溶け合う様子を描画しています。",
    outlineEN:"This website was created to promote the exhibition \"Organic and Inorganic\", which was held at the University Festival of Tokyo Metropolitan University. In the background, Three.js and WebGL are used to draw the process of organic and inorganic shapes melting together.",
    thoughtJA:"展示の軸である「有機的、無機的」を展示内容とは異なるビジュアルでありながらも一目でタイトルとの一貫性を持たせることを目指しました。また、ファーストビューの文字情報を大胆に配置することでWebサイトでありながらもポスター的な存在感を持たせることを意識しました。",
    thoughtEN:"I aimed to give a consistent visual impression with the title at a glance, even though it was a different visual from the exhibition content, which is the axis of the exhibition. In addition, I was conscious of giving a poster-like presence to the website by boldly placing the character information of the first view.",
  },
  {
    junle: "Web_Content",
    name: "Proof of X",
